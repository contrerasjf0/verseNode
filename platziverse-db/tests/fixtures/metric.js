...
const metrics = [
  ...
  util.extend(metric, {id: 4, agentId: agentFixture.all[2], type: 'CPU', value: 23}),
  util.extend(metric, {id: 5, agentId: agentFixture.all[2], type: 'CPU', value: 22}),
  util.extend(metric, {id: 6, agentId: agentFixture.all[3], type: 'GPU', value: 99}),
  util.extend(metric, {id: 7, agentId: agentFixture.all[3], type: 'GPU', value: 88})
]
